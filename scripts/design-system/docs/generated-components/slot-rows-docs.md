...
```html
<button class="slot-rows slot-rows--primary">Primary</button>
<button class="slot-rows slot-rows--secondary">Secondary</button>
```

## Sizes

```html
<button class="slot-rows slot-rows--sm">Small</button>
<button class="slot-rows slot-rows--md">Medium</button>
<button class="slot-rows slot-rows--lg">Large</button>
<button class="slot-rows slot-rows--xl">Extra Large</button>
```
...
## Generated Files
- `slot rows-demo.html` - Interactive demo
- `slot rows.css` - Component styles
- `slot rows-test.html` - Test file
- `slot rows-docs.md` - This documentation
