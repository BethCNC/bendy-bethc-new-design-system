...
```html
<button class="copy-blocks copy-blocks--primary">Primary</button>
<button class="copy-blocks copy-blocks--secondary">Secondary</button>
```

## Sizes

```html
<button class="copy-blocks copy-blocks--sm">Small</button>
<button class="copy-blocks copy-blocks--md">Medium</button>
<button class="copy-blocks copy-blocks--lg">Large</button>
<button class="copy-blocks copy-blocks--xl">Extra Large</button>
```
...
## Generated Files
- `copy blocks-demo.html` - Interactive demo
- `copy blocks.css` - Component styles
- `copy blocks-test.html` - Test file
- `copy blocks-docs.md` - This documentation
