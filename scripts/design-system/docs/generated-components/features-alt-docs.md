...
```html
<button class="features-alt features-alt--primary">Primary</button>
<button class="features-alt features-alt--secondary">Secondary</button>
```

## Sizes

```html
<button class="features-alt features-alt--sm">Small</button>
<button class="features-alt features-alt--md">Medium</button>
<button class="features-alt features-alt--lg">Large</button>
<button class="features-alt features-alt--xl">Extra Large</button>
```
...
## Generated Files
- `features alt-demo.html` - Interactive demo
- `features alt.css` - Component styles
- `features alt-test.html` - Test file
- `features alt-docs.md` - This documentation
