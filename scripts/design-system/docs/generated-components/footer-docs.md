...
```html
<button class="footer footer--primary">Primary</button>
<button class="footer footer--secondary">Secondary</button>
```

## Sizes

```html
<button class="footer footer--sm">Small</button>
<button class="footer footer--md">Medium</button>
<button class="footer footer--lg">Large</button>
<button class="footer footer--xl">Extra Large</button>
```
...
## Generated Files
- `footer-demo.html` - Interactive demo
- `footer.css` - Component styles
- `footer-test.html` - Test file
- `footer-docs.md` - This documentation
