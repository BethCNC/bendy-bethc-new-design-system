...
```html
<button class="demo-card demo-card--primary">Primary</button>
<button class="demo-card demo-card--secondary">Secondary</button>
```

## Sizes

```html
<button class="demo-card demo-card--sm">Small</button>
<button class="demo-card demo-card--md">Medium</button>
<button class="demo-card demo-card--lg">Large</button>
<button class="demo-card demo-card--xl">Extra Large</button>
```
...
## Generated Files
- `demo card-demo.html` - Interactive demo
- `demo card.css` - Component styles
- `demo card-test.html` - Test file
- `demo card-docs.md` - This documentation
