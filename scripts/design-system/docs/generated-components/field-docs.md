...
```html
<button class="field field--primary">Primary</button>
<button class="field field--secondary">Secondary</button>
```

## Sizes

```html
<button class="field field--sm">Small</button>
<button class="field field--md">Medium</button>
<button class="field field--lg">Large</button>
<button class="field field--xl">Extra Large</button>
```
...
## Generated Files
- `field-demo.html` - Interactive demo
- `field.css` - Component styles
- `field-test.html` - Test file
- `field-docs.md` - This documentation
