...
```html
<button class="image-gallery image-gallery--primary">Primary</button>
<button class="image-gallery image-gallery--secondary">Secondary</button>
```

## Sizes

```html
<button class="image-gallery image-gallery--sm">Small</button>
<button class="image-gallery image-gallery--md">Medium</button>
<button class="image-gallery image-gallery--lg">Large</button>
<button class="image-gallery image-gallery--xl">Extra Large</button>
```
...
## Generated Files
- `image gallery-demo.html` - Interactive demo
- `image gallery.css` - Component styles
- `image gallery-test.html` - Test file
- `image gallery-docs.md` - This documentation
