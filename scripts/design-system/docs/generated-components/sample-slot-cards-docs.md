...
```html
<button class="sample-slot-cards">
    Sample Slot Cards
</button>
```
...
```html
<button class="sample-slot-cards sample-slot-cards--primary">Primary</button>
<button class="sample-slot-cards sample-slot-cards--secondary">Secondary</button>
```

## Sizes

```html
<button class="sample-slot-cards sample-slot-cards--sm">Small</button>
<button class="sample-slot-cards sample-slot-cards--md">Medium</button>
<button class="sample-slot-cards sample-slot-cards--lg">Large</button>
<button class="sample-slot-cards sample-slot-cards--xl">Extra Large</button>
```
...
## Generated Files
- `sample slot cards-demo.html` - Interactive demo
- `sample slot cards.css` - Component styles
- `sample slot cards-test.html` - Test file
- `sample slot cards-docs.md` - This documentation
