...
```html
<button class="image-placeholders">
    Image Placeholders
</button>
```
...
```html
<button class="image-placeholders image-placeholders--primary">Primary</button>
<button class="image-placeholders image-placeholders--secondary">Secondary</button>
```

## Sizes

```html
<button class="image-placeholders image-placeholders--sm">Small</button>
<button class="image-placeholders image-placeholders--md">Medium</button>
<button class="image-placeholders image-placeholders--lg">Large</button>
<button class="image-placeholders image-placeholders--xl">Extra Large</button>
```
...
## Generated Files
- `image placeholders-demo.html` - Interactive demo
- `image placeholders.css` - Component styles
- `image placeholders-test.html` - Test file
- `image placeholders-docs.md` - This documentation
