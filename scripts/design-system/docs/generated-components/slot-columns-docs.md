...
```html
<button class="slot-columns slot-columns--primary">Primary</button>
<button class="slot-columns slot-columns--secondary">Secondary</button>
```

## Sizes

```html
<button class="slot-columns slot-columns--sm">Small</button>
<button class="slot-columns slot-columns--md">Medium</button>
<button class="slot-columns slot-columns--lg">Large</button>
<button class="slot-columns slot-columns--xl">Extra Large</button>
```
...
## Generated Files
- `slot columns-demo.html` - Interactive demo
- `slot columns.css` - Component styles
- `slot columns-test.html` - Test file
- `slot columns-docs.md` - This documentation
