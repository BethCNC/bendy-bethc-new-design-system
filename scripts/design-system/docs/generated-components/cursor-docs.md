...
```html
<button class="cursor cursor--primary">Primary</button>
<button class="cursor cursor--secondary">Secondary</button>
```

## Sizes

```html
<button class="cursor cursor--sm">Small</button>
<button class="cursor cursor--md">Medium</button>
<button class="cursor cursor--lg">Large</button>
<button class="cursor cursor--xl">Extra Large</button>
```
...
## Generated Files
- `cursor-demo.html` - Interactive demo
- `cursor.css` - Component styles
- `cursor-test.html` - Test file
- `cursor-docs.md` - This documentation
