...
```html
<button class="icon-only-button icon-only-button--primary">Primary</button>
<button class="icon-only-button icon-only-button--secondary">Secondary</button>
```

## Sizes

```html
<button class="icon-only-button icon-only-button--sm">Small</button>
<button class="icon-only-button icon-only-button--md">Medium</button>
<button class="icon-only-button icon-only-button--lg">Large</button>
<button class="icon-only-button icon-only-button--xl">Extra Large</button>
```
...
## Generated Files
- `icon only button-demo.html` - Interactive demo
- `icon only button.css` - Component styles
- `icon only button-test.html` - Test file
- `icon only button-docs.md` - This documentation
