...
```html
<button class="label label--primary">Primary</button>
<button class="label label--secondary">Secondary</button>
```

## Sizes

```html
<button class="label label--sm">Small</button>
<button class="label label--md">Medium</button>
<button class="label label--lg">Large</button>
<button class="label label--xl">Extra Large</button>
```
...
## Generated Files
- `label-demo.html` - Interactive demo
- `label.css` - Component styles
- `label-test.html` - Test file
- `label-docs.md` - This documentation
