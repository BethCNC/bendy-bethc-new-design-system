...
```html
<button class="demo-button demo-button--sm">Small</button>
<button class="demo-button demo-button--md">Medium</button>
<button class="demo-button demo-button--lg">Large</button>
<button class="demo-button demo-button--xl">Extra Large</button>
```
...
## Generated Files
- `demo button-demo.html` - Interactive demo
- `demo button.css` - Component styles
- `demo button-test.html` - Test file
- `demo button-docs.md` - This documentation
