...
```html
<button class="avatar avatar--primary">Primary</button>
<button class="avatar avatar--secondary">Secondary</button>
```

## Sizes

```html
<button class="avatar avatar--sm">Small</button>
<button class="avatar avatar--md">Medium</button>
<button class="avatar avatar--lg">Large</button>
<button class="avatar avatar--xl">Extra Large</button>
```
...
## Generated Files
- `avatar-demo.html` - Interactive demo
- `avatar.css` - Component styles
- `avatar-test.html` - Test file
- `avatar-docs.md` - This documentation
