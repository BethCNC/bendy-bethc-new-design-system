...
```html
<button class="chip chip--primary">Primary</button>
<button class="chip chip--secondary">Secondary</button>
```

## Sizes

```html
<button class="chip chip--sm">Small</button>
<button class="chip chip--md">Medium</button>
<button class="chip chip--lg">Large</button>
<button class="chip chip--xl">Extra Large</button>
```
...
## Generated Files
- `chip-demo.html` - Interactive demo
- `chip.css` - Component styles
- `chip-test.html` - Test file
- `chip-docs.md` - This documentation
