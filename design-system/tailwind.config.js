  ...
  theme: {
    extend: {
      ...
      borderRadius: {
        ...
        "button-md": "var(--button-radius-md)",
        "button-lg": "var(--button-radius-lg)",
        "button-xl": "var(--button-radius-xl)",
        "chip-sm": "var(--chip-radius-sm)",
        "chip-md": "var(--chip-radius-md)",
        "chip-lg": "var(--chip-radius-lg)",
        "chip-xl": "var(--chip-radius-xl)"
},
      borderWidth: {
        "button-sm": "var(--button-icon-border-width-sm)",
        "button-md": "var(--button-icon-border-width-md)",
        "button-lg": "var(--button-icon-border-width-lg)",
        "button-xl": "var(--button-icon-border-width-xl)",
        "chip-sm": "var(--chip-border-width-sm)",
        "chip-md": "var(--chip-border-width-md)",
        "chip-lg": "var(--chip-border-width-lg)",
        "chip-xl": "var(--chip-border-width-xl)"
},
      spacing: Object.assign({}, {
        "button-h-padding-sm": "var(--button-h-padding-sm)",
        "button-v-padding-sm": "var(--button-v-padding-sm)",
        "button-spacing-sm": "var(--button-spacing-sm)",
        "button-full-padding-sm": "var(--button-full-padding-sm)",
        "button-h-padding-md": "var(--button-h-padding-md)",
        "button-v-padding-md": "var(--button-v-padding-md)",
        "button-spacing-md": "var(--button-spacing-md)",
        "button-full-padding-md": "var(--button-full-padding-md)",
        "button-h-padding-lg": "var(--button-h-padding-lg)",
        "button-v-padding-lg": "var(--button-v-padding-lg)",
        "button-spacing-lg": "var(--button-spacing-lg)",
        "button-full-padding-lg": "var(--button-full-padding-lg)",
        "button-h-padding-xl": "var(--button-h-padding-xl)",
        "button-v-padding-xl": "var(--button-v-padding-xl)",
        "button-spacing-xl": "var(--button-spacing-xl)",
        "button-full-padding-xl": "var(--button-full-padding-xl)",
        "chip-h-padding-sm": "var(--chip-h-padding-sm)",
        "chip-v-padding-sm": "var(--chip-v-padding-sm)",
        "chip-spacing-sm": "var(--chip-spacing-sm)",
        "chip-full-padding-sm": "var(--chip-full-padding-sm)",
        "chip-h-padding-md": "var(--chip-h-padding-md)",
        "chip-v-padding-md": "var(--chip-v-padding-md)",
        "chip-spacing-md": "var(--chip-spacing-md)",
        "chip-full-padding-md": "var(--chip-full-padding-md)",
        "chip-h-padding-lg": "var(--chip-h-padding-lg)",
        "chip-v-padding-lg": "var(--chip-v-padding-lg)",
        "chip-spacing-lg": "var(--chip-spacing-lg)",
        "chip-full-padding-lg": "var(--chip-full-padding-lg)",
        "chip-h-padding-xl": "var(--chip-h-padding-xl)",
        "chip-v-padding-xl": "var(--chip-v-padding-xl)",
        "chip-spacing-xl": "var(--chip-spacing-xl)",
        "chip-full-padding-xl": "var(--chip-full-padding-xl)"
}),
    },
  },
  plugins: [
    require('./js/tailwind-plugin.js')
  ],
}